      ...
      <div className="flex-1 flex flex-col px-4 py-6 z-10 relative pb-8 w-full max-w-4xl mx-auto space-y-6 md:space-y-8">
        ...
        <div className="space-y-4 pt-4">
          ...
          {(!isExtraSiangLockedTime || !isExtraMalamLockedTime) && (
            ...
            >
              Batas order untuk makan siang pukul 09.00 WIB, dan untuk makan malam 14.00 WIB.
            </Alert>
          )}
          ...
          {isExtraSiangLockedTime ? (
            <div className="bg-white shadow-sm border border-slate-200 border-l-[4px] border-l-amber-600 rounded-xl p-4 flex items-center gap-3 mt-2 mb-4">
              ...
              <span className="text-[14px] font-bold text-slate-700">Batas order ekstra siang habis (09:00 WIB)</span>
            </div>
          ) : (
            <Accordion 
              title="Makan Siang" 
